...
class Config {
  // API Configuration - bisa dari .env atau hardcoded untuk development
  static String get baseUrl {
    // Coba ambil dari environment variable, jika tidak ada pakai default
    return dotenv.env['API_URL'] ?? 'http://127.0.0.1:8000';
  }
