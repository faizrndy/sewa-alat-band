  ...
  <div class="min-h-screen bg-[#0a0a0a] text-white py-10 px-6 font-sans pt-28">
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div class="lg:col-span-3 mb-2">
         ...
         <p class="text-gray-500 mt-2 text-sm md:text-base">Cek lagi barang bawaan lo sebelum manggung.</p>
      </div>
            ...
            <div v-for="item in itemsKeranjang" :key="item.id" class="flex gap-4 bg-black/40 p-4 rounded-2xl border border-gray-800/50">
              ...
              <div class="flex-1 flex flex-col justify-center">
                ...
                <div class="text-xs text-gray-500 mt-1 font-mono flex flex-wrap gap-2 items-center">
                  <span class="bg-gray-800 px-2 py-0.5 rounded text-gray-300">{{ item.tanggalMulai }} <span class="text-rose-500">➜</span> {{ item.tanggalSelesai }}</span>
                  <span class="text-rose-500 font-bold">({{ hitungHari(item) }} Hari)</span>
                </div>
                <div class="mt-2 flex items-center justify-between">
                  ...
                  <p class="font-bold text-white">
                    Rp {{ (hitungHari(item) * item.harga_sewa * item.jumlah).toLocaleString() }}
                  </p>
                </div>
              </div>
            </div>
             ...
             <div class="md:col-span-2">
               ...
               <div class="relative border-2 border-dashed border-gray-700 bg-black/30 rounded-xl p-6 text-center cursor-pointer hover:bg-gray-800 hover:border-rose-600 transition group">
                  ...
                  <div v-if="!fileIdentitas" class="flex flex-col items-center text-gray-500 group-hover:text-rose-500 transition">
                    ...
                    <p class="text-[10px] text-gray-600 mt-1">Format: JPG, PNG, PDF (Max 2MB)</p>
                  </div>
      ...
      <div class="lg:col-span-1">
        <div class="bg-[#151515] p-6 rounded-3xl border border-gray-800 sticky top-28 shadow-2xl">
          ...
          <div class="mt-6 flex justify-center gap-3 opacity-50 grayscale hover:grayscale-0 transition duration-500">
             <i class="fab fa-cc-visa text-2xl text-white"></i>
             <i class="fab fa-cc-mastercard text-2xl text-white"></i>
             <i class="fas fa-wallet text-2xl text-white"></i>
          </div>
          <p class="text-[10px] text-center text-gray-600 mt-2 uppercase tracking-widest">Secured by Midtrans</p>
        </div>
      </div>
